...
import districtCoordinatorRoutes from "./routes/districtCoordinatorRoutes.js";
import teamRoutes from "./routes/teamRoutes.js";
import facilityRoutes from "./routes/facilityRoutes.js";
import socialMobilizerPlanRoutes from "./routes/socialMobilizerPlanRoutes.js";
...
app.use("/api/district-coordinators", districtCoordinatorRoutes);
app.use("/api/teams", teamRoutes);
app.use("/api/facilities", facilityRoutes);
app.use("/api/mobilizer-plans", socialMobilizerPlanRoutes);
